    ...
    return (
        <>
            <div className="PreFooter">
                <div>
                    {repeatIcon}
                    <p><b>Hassle-free replacement</b> <b>10-day easy replacement policy on mi.com</b></p>
                </div>

                <div>
                    {shieldIcon}<p><b>100% secure payments</b><br />We Support Cards,Wallets,EMI and COD </p>
                </div>
                <div>{mapIcon}<p><b>Vat Service Netork</b><br />1000 mi service-centers across 600 cCities</p> </div>
            ...
            <div className="PreFooter2">
                ...
                <div>
                    ...
                    <span>Thanks. You're on our email list Special Offers.</span>
                </div>

                <div>
                    <p> FOLLOW MI </p>
                    <sapn> We Want to hear From You!</sapn>
                </div>
            ...
            <div>
                <div>Copyright 0 2010-2023 xiaomi. All Rights Reserved </div>
            </div>
